...
- The default period follows the TA-Lib moving-average family; other packages default to shorter windows (10 or 20). Compare across implementations with an explicit period.
