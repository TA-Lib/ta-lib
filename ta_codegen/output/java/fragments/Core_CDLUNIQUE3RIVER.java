 ...
 */
   ...
   RetCode CDLUNIQUE3RIVER_Body( int startIdx,
                                 int endIdx,
                                 double inOpen[],
                                 double inHigh[],
                                 double inLow[],
                                    ...
                                    int outInteger[] )
   {
      ...
      RetCode retCode = CDLUNIQUE3RIVER_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
