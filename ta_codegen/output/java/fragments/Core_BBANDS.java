...
/**** Streaming API *****/
   ...
   public static final class BbandsStream {
       ...
       * by one and nothing else moves — {@link #value(BbandsOut)} keeps answering the previous
       ...
       * {@link #value(BbandsOut)} still answers the previous value. Re-feed the bar when a
