...
/**** Streaming API *****/
   ...
   public static final class DivStream {
      ...
      public double update( double inReal0, double inReal1 ) {
         ...
         if( !Double.isFinite(inReal0) || !Double.isFinite(inReal1) )
            throw new TALibArgumentException("DIV update: BAD_PARAM", RetCode.BAD_PARAM);
      ...
      public double peek( double inReal0, double inReal1 ) {
         if( !Double.isFinite(inReal0) || !Double.isFinite(inReal1) )
            throw new TALibArgumentException("DIV peek: BAD_PARAM", RetCode.BAD_PARAM);
         DivStream sp = this;
   ...
   public DivStream divOpenAndFill( double inReal0[], double inReal1[], double outReal[] )
   {
      ...
      if( (Object)outReal == (Object)inReal0 || (Object)outReal == (Object)inReal1 ) {
         throw new TALibArgumentException("DIV openAndFill: " + RetCode.BAD_PARAM, RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
