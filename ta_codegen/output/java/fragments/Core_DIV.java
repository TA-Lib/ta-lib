...
/**** Streaming API *****/
   ...
   public static final class DivStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("DIV advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
      ...
      public double update( double inReal0, double inReal1 ) {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("DIV update", RetCode.OUT_OF_RANGE_END_INDEX);
         if( !Double.isFinite(inReal0) || !Double.isFinite(inReal1) )
            throw nonFiniteBar("DIV update", !Double.isFinite(inReal0) ? "inReal0" : "inReal1");
      ...
      public double peek( double inReal0, double inReal1 ) {
         if( !Double.isFinite(inReal0) || !Double.isFinite(inReal1) )
            throw nonFiniteBar("DIV peek", !Double.isFinite(inReal0) ? "inReal0" : "inReal1");
         DivStream sp = this;
   ...
   DivStream divOpenAndFillInternal( double inReal0[], double inReal1[], int startIdx, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("DIV openAndFill", inReal0.length, startIdx, divLookback());
      }
   ...
   DivStream divOpenInternal( double inReal0[], double inReal1[], int startIdx )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("DIV open", inReal0.length, startIdx, divLookback());
      }
   ...
   public DivStream divOpenAndFill( double inReal0[], double inReal1[], double outReal[] )
   {
      ...
      if( (Object)outReal == (Object)inReal0 || (Object)outReal == (Object)inReal1 ) {
         throw streamFailure("DIV openAndFill", RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
