 ...
 */
                                 ...
                                 int outInteger[] )
   {
      ...
      int guardStart = clampedStart("CDLTHRUSTING", startIdx, cdlthrustingLookback());
      ...
      RetCode retCode = cdlthrustingImpl(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public CdlthrustingStream cdlthrustingOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      int guardOutLen = openFillCount("CDLTHRUSTING openAndFill", inOpen.length, cdlthrustingLookback());
