 ...
 */
   ...
   RetCode cdl3BlackCrowsInternal( int startIdx,
                                   int endIdx,
                                   double inOpen[],
                                   double inHigh[],
                                   double inLow[],
                                   ...
                                   int outInteger[] )
   {
      ...
      RetCode retCode = cdl3BlackCrowsInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
    ...
    * {@link Cdl3BlackCrowsStream#fillRange()}.
    */
