 ...
 */
   ...
   RetCode CDL3BLACKCROWS_Body( int startIdx,
                                int endIdx,
                                double inOpen[],
                                double inHigh[],
                                double inLow[],
                                   ...
                                   int outInteger[] )
   {
      ...
      RetCode retCode = CDL3BLACKCROWS_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CDL3BLACKCROWS_Stream {
      ...
      /**
       * The range filled by {@link Core#CDL3BLACKCROWS_OpenAndFill}, or
    ...
    * {@link CDL3BLACKCROWS_Stream#fillRange()}.
    */
