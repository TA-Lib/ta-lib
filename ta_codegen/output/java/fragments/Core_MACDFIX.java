...
/**** Streaming API *****/
   ...
   public static final class MacdfixStream {
       ...
       * by one and nothing else moves — {@link #value(MacdfixOut)} keeps answering the previous
       ...
       * {@link #value(MacdfixOut)} still answers the previous value. Re-feed the bar when a
