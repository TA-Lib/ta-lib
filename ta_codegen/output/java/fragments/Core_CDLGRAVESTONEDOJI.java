 ...
 */
    ...
    *        to the trend) Must hold at least {@code endIdx - startIdx + 1} values.
...
/**** Streaming API *****/
   ...
   public static final class CdlgravestonedojiStream {
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         ...
         if( !Double.isFinite(inOpen) || !Double.isFinite(inHigh) || !Double.isFinite(inLow) || !Double.isFinite(inClose) )
            throw new TALibArgumentException("CDLGRAVESTONEDOJI update: BAD_PARAM", RetCode.BAD_PARAM);
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         if( !Double.isFinite(inOpen) || !Double.isFinite(inHigh) || !Double.isFinite(inLow) || !Double.isFinite(inClose) )
            throw new TALibArgumentException("CDLGRAVESTONEDOJI peek: BAD_PARAM", RetCode.BAD_PARAM);
   ...
   public CdlgravestonedojiStream cdlgravestonedojiOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      if( (Object)outInteger == (Object)inOpen || (Object)outInteger == (Object)inHigh || (Object)outInteger == (Object)inLow || (Object)outInteger == (Object)inClose ) {
         throw new TALibArgumentException("CDLGRAVESTONEDOJI openAndFill: " + RetCode.BAD_PARAM, RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
