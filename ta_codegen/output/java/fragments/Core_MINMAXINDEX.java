 ...
 */
   ...
   RetCode MINMAXINDEX_Body( int startIdx,
                             int endIdx,
                             double inReal[],
                             int optInTimePeriod,
                             MInteger outBegIdx,
                                ...
                                int outMaxIdx[] )
   {
      ...
      RetCode retCode = MINMAXINDEX_Body(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outMinIdx, outMaxIdx);
...
/**** Streaming API *****/
   ...
   public static final class MINMAXINDEX_Stream {
      ...
      /**
       * The range filled by {@link Core#MINMAXINDEX_OpenAndFill}, or
    ...
    * {@link MINMAXINDEX_Stream#fillRange()}.
    */
