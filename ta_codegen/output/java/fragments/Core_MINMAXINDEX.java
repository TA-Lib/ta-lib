 ...
 */
                                ...
                                int outMaxIdx[] )
   {
      ...
      int guardStart = clampedStart("MINMAXINDEX", startIdx, minmaxindexLookback(optInTimePeriod));
      ...
      RetCode retCode = minmaxindexImpl(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outMinIdx, outMaxIdx);
...
/**** Streaming API *****/
   ...
   public static final class MinmaxindexStream {
       ...
       * by one and nothing else moves — {@link #value(MinmaxindexOut)} keeps answering the previous
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > MAX_INDEX )
            throw failure("MINMAXINDEX advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
       ...
       * {@link #value(MinmaxindexOut)} still answers the previous value. Re-feed the bar when a
