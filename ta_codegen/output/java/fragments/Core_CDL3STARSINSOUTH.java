 ...
 */
                                     ...
                                     int outInteger[] )
   {
      ...
      int guardStart = clampedStart("CDL3STARSINSOUTH", startIdx, cdl3starsinsouthLookback());
      ...
      RetCode retCode = cdl3starsinsouthImpl(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class Cdl3starsinsouthStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("CDL3STARSINSOUTH advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("CDL3STARSINSOUTH update", RetCode.OUT_OF_RANGE_END_INDEX);
         if( !Double.isFinite(inOpen) || !Double.isFinite(inHigh) || !Double.isFinite(inLow) || !Double.isFinite(inClose) )
            throw nonFiniteBar("CDL3STARSINSOUTH update", !Double.isFinite(inOpen) ? "inOpen" : !Double.isFinite(inHigh) ? "inHigh" : !Double.isFinite(inLow) ? "inLow" : "inClose");
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         if( !Double.isFinite(inOpen) || !Double.isFinite(inHigh) || !Double.isFinite(inLow) || !Double.isFinite(inClose) )
            throw nonFiniteBar("CDL3STARSINSOUTH peek", !Double.isFinite(inOpen) ? "inOpen" : !Double.isFinite(inHigh) ? "inHigh" : !Double.isFinite(inLow) ? "inLow" : "inClose");
   ...
   Cdl3starsinsouthStream cdl3starsinsouthOpenAndFillInternal( double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx, MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("CDL3STARSINSOUTH openAndFill", inOpen.length, startIdx, cdl3starsinsouthLookback());
      }
   ...
   Cdl3starsinsouthStream cdl3starsinsouthOpenInternal( double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("CDL3STARSINSOUTH open", inOpen.length, startIdx, cdl3starsinsouthLookback());
      }
   ...
   public Cdl3starsinsouthStream cdl3starsinsouthOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      if( (Object)outInteger == (Object)inOpen || (Object)outInteger == (Object)inHigh || (Object)outInteger == (Object)inLow || (Object)outInteger == (Object)inClose ) {
         throw streamFailure("CDL3STARSINSOUTH openAndFill", RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
