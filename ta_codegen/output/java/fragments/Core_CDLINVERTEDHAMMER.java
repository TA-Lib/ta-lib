 ...
 */
                                      ...
                                      int outInteger[] )
   {
      ...
      int guardStart = clampedStart("CDLINVERTEDHAMMER", startIdx, cdlinvertedhammerLookback());
      ...
      RetCode retCode = cdlinvertedhammerImpl(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public CdlinvertedhammerStream cdlinvertedhammerOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      int guardOutLen = openFillCount("CDLINVERTEDHAMMER openAndFill", inOpen.length, cdlinvertedhammerLookback());
