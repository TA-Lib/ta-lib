 ...
 */
                         ...
                         double outReal[] )
   {
      ...
      int guardStart = clampedStart("SINH", startIdx, sinhLookback());
      ...
      RetCode retCode = sinhImpl(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
...
/**** Streaming API *****/
   ...
   public static final class SinhStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("SINH advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
      ...
      public double update( double inReal ) {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("SINH update", RetCode.OUT_OF_RANGE_END_INDEX);
         if( !Double.isFinite(inReal) )
            throw nonFiniteBar("SINH update", "inReal");
      ...
      public double peek( double inReal ) {
         if( !Double.isFinite(inReal) )
            throw nonFiniteBar("SINH peek", "inReal");
         SinhStream sp = this;
   ...
   SinhStream sinhOpenAndFillInternal( double inReal[], int startIdx, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("SINH openAndFill", inReal.length, startIdx, sinhLookback());
      }
   ...
   SinhStream sinhOpenInternal( double inReal[], int startIdx )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("SINH open", inReal.length, startIdx, sinhLookback());
      }
      throw streamFailure("SINH open", retCode);
   }
   /**
   ...
   public SinhStream sinhOpenAndFill( double inReal[], double outReal[] )
   {
      ...
      int guardOutLen = openFillCount("SINH openAndFill", inReal.length, sinhLookback());
      requireLength("SINH openAndFill", "outReal", outReal, guardOutLen);
      if( (Object)outReal == (Object)inReal ) {
         throw streamFailure("SINH openAndFill", RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
