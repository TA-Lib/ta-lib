 ...
 */
   ...
   RetCode cdlLadderBottomInternal( int startIdx,
                                    int endIdx,
                                    double inOpen[],
                                    double inHigh[],
                                    double inLow[],
                                    ...
                                    int outInteger[] )
   {
      ...
      RetCode retCode = cdlLadderBottomInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
    ...
    * {@link CdlLadderBottomStream#fillRange()}.
    */
