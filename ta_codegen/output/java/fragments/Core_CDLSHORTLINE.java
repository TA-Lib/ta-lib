 ...
 */
                                 ...
                                 int outInteger[] )
   {
      ...
      int guardStart = clampedStart("CDLSHORTLINE", startIdx, cdlshortlineLookback());
      ...
      RetCode retCode = cdlshortlineImpl(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CdlshortlineStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > MAX_INDEX )
            throw failure("CDLSHORTLINE advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
   ...
   public CdlshortlineStream cdlshortlineOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      int guardOutLen = openFillCount("CDLSHORTLINE openAndFill", inOpen.length, cdlshortlineLookback());
