 ...
 */
   ...
   RetCode CDLSHORTLINE_Body( int startIdx,
                              int endIdx,
                              double inOpen[],
                              double inHigh[],
                              double inLow[],
                                 ...
                                 int outInteger[] )
   {
      ...
      RetCode retCode = CDLSHORTLINE_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CDLSHORTLINE_Stream {
      ...
      /**
       * The range filled by {@link Core#CDLSHORTLINE_OpenAndFill}, or
    ...
    * {@link CDLSHORTLINE_Stream#fillRange()}.
    */
