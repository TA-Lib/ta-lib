...
/**** Streaming API *****/
   ...
   public static final class LinearregInterceptStream {
      ...
      public double update( double inReal ) {
         ...
         if( !Double.isFinite(inReal) )
            throw nonFiniteBar("LINEARREG_INTERCEPT update", "inReal");
      ...
      public double peek( double inReal ) {
         if( !Double.isFinite(inReal) )
            throw nonFiniteBar("LINEARREG_INTERCEPT peek", "inReal");
   ...
   LinearregInterceptStream linearregInterceptOpenAndFillInternal( double inReal[], int startIdx, int optInTimePeriod, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("LINEARREG_INTERCEPT openAndFill", inReal.length, startIdx, linearregInterceptLookback(optInTimePeriod));
      }
      throw streamFailure("LINEARREG_INTERCEPT openAndFill", retCode);
   }
   ...
   LinearregInterceptStream linearregInterceptOpenInternal( double inReal[], int startIdx, int optInTimePeriod )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("LINEARREG_INTERCEPT open", inReal.length, startIdx, linearregInterceptLookback(optInTimePeriod));
      }
      throw streamFailure("LINEARREG_INTERCEPT open", retCode);
   }
   /**
   ...
   public LinearregInterceptStream linearregInterceptOpenAndFill( double inReal[], int optInTimePeriod, double outReal[] )
   {
      ...
      if( (Object)outReal == (Object)inReal ) {
         throw streamFailure("LINEARREG_INTERCEPT openAndFill", RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
