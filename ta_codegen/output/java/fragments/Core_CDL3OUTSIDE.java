 ...
 */
   ...
   RetCode CDL3OUTSIDE_Body( int startIdx,
                             int endIdx,
                             double inOpen[],
                             double inHigh[],
                             double inLow[],
                                ...
                                int outInteger[] )
   {
      ...
      RetCode retCode = CDL3OUTSIDE_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CDL3OUTSIDE_Stream {
      ...
      /**
       * The range filled by {@link Core#CDL3OUTSIDE_OpenAndFill}, or
    ...
    * {@link CDL3OUTSIDE_Stream#fillRange()}.
    */
