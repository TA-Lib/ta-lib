 ...
 */
   ...
   RetCode cdlClosingMarubozuInternal( int startIdx,
                                       int endIdx,
                                       double inOpen[],
                                       double inHigh[],
                                       double inLow[],
                                       ...
                                       int outInteger[] )
   {
      ...
      RetCode retCode = cdlClosingMarubozuInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CdlClosingMarubozuStream {
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         core.cdlClosingMarubozuStreamStep(this, inOpen, inHigh, inLow, inClose);
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         CdlClosingMarubozuStream scratch = new CdlClosingMarubozuStream(this);
         core.cdlClosingMarubozuStreamStep(scratch, inOpen, inHigh, inLow, inClose);
   ...
   void cdlClosingMarubozuStreamStep( CdlClosingMarubozuStream sp, double inOpen, double inHigh, double inLow, double inClose )
   {
      ...
      if( Math.abs(inClose - inOpen) > ((BodyLong_factor * (((BodyLong_avgPeriod != 0) ? (sp.BodyLongPeriodTotal / BodyLong_avgPeriod) : ((BodyLong_rangeType == 0) ? (Math.abs(inClose - inOpen)) : ((BodyLong_rangeType == 1) ? (inHigh - inLow) : ((BodyLong_rangeType == 2) ? ((inHigh - inLow) - Math.abs(inClose - inOpen)) : 0.0)))) / ((BodyLong_rangeType == 2) ? 2.0 : 1.0)))) && /* long body */
          (((inClose >= inOpen) ? 1 : 0 - 1) == 1 && (inHigh - ((inClose >= inOpen) ? inClose : inOpen)) < ((ShadowVeryShort_factor * (((ShadowVeryShort_avgPeriod != 0) ? (sp.ShadowVeryShortPeriodTotal / ShadowVeryShort_avgPeriod) : ((ShadowVeryShort_rangeType == 0) ? (Math.abs(inClose - inOpen)) : ((ShadowVeryShort_rangeType == 1) ? (inHigh - inLow) : ((ShadowVeryShort_rangeType == 2) ? ((inHigh - inLow) - Math.abs(inClose - inOpen)) : 0.0)))) / ((ShadowVeryShort_rangeType == 2) ? 2.0 : 1.0)))) || ((inClose >= inOpen) ? 1 : 0 - 1) == 0 - 1 && (((inClose >= inOpen) ? inOpen : inClose) - inLow) < ((ShadowVeryShort_factor * (((ShadowVeryShort_avgPeriod != 0) ? (sp.ShadowVeryShortPeriodTotal / ShadowVeryShort_avgPeriod) : ((ShadowVeryShort_rangeType == 0) ? (Math.abs(inClose - inOpen)) : ((ShadowVeryShort_rangeType == 1) ? (inHigh - inLow) : ((ShadowVeryShort_rangeType == 2) ? ((inHigh - inLow) - Math.abs(inClose - inOpen)) : 0.0)))) / ((ShadowVeryShort_rangeType == 2) ? 2.0 : 1.0))))) ) /* white body and very short lower shadow black body and very short upper shadow */
      {
   ...
   private RetCode cdlClosingMarubozuOpenBody( CdlClosingMarubozuStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      double BodyLongPeriodTotal = 0;
      double ShadowVeryShortPeriodTotal = 0;
      int i = 0;
   ...
   private RetCode cdlClosingMarubozuOpenAndFillBody( CdlClosingMarubozuStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      double BodyLongPeriodTotal = 0;
      double ShadowVeryShortPeriodTotal = 0;
      int i = 0;
   ...
   CdlClosingMarubozuStream cdlClosingMarubozuOpenInternal( double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      ...
      RetCode retCode = cdlClosingMarubozuOpenBody(sp, inOpen, inHigh, inLow, inClose, startIdx);
      if( retCode == RetCode.Success ) {
         return sp;
      }
    ...
    */
   public CdlClosingMarubozuStream cdlClosingMarubozuOpen( double inOpen[], double inHigh[], double inLow[], double inClose[] )
   {
    ...
    * {@link CdlClosingMarubozuStream#fillRange()}.
    */
   public CdlClosingMarubozuStream cdlClosingMarubozuOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      CdlClosingMarubozuStream sp = new CdlClosingMarubozuStream(this);
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      RetCode retCode = cdlClosingMarubozuOpenAndFillBody(sp, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
