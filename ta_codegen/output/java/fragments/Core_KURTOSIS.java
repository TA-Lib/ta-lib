 ...
 */
   ...
   RetCode KURTOSIS_Impl( int startIdx,
                          int endIdx,
                          double inReal[],
                          int optInTimePeriod,
                          MInteger outBegIdx,
    ...
    * valid range shorter than {@link Core#KURTOSIS_Lookback} is a <b>success
                             ...
                             double outReal[] )
   {
      ...
      int guardStart = clampedStart("KURTOSIS", startIdx, KURTOSIS_Lookback(optInTimePeriod));
      ...
      RetCode retCode = KURTOSIS_Impl(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outReal);
...
/**** Streaming API *****/
   ...
   public static final class KurtosisStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > MAX_INDEX )
            throw failure("KURTOSIS advance", RetCode.OutOfRangeEndIndex);
         this.outRangeCount++;
      }
      ...
      public double update( double inReal ) {
         if( this.outRangeBegIdx + this.outRangeCount > MAX_INDEX )
            throw failure("KURTOSIS update", RetCode.OutOfRangeEndIndex);
         if( !Double.isFinite(inReal) )
            throw new TaLibArgumentException("KURTOSIS update: BadParam", RetCode.BadParam);
      ...
      public double peek( double inReal ) {
         if( !Double.isFinite(inReal) )
            throw new TaLibArgumentException("KURTOSIS peek: BadParam", RetCode.BadParam);
    ...
    * <p>The history must hold at least {@code KURTOSIS_Lookback(...) + 1} bars
   ...
   public KurtosisStream kurtosisOpenAndFill( double inReal[], int optInTimePeriod, double outReal[] )
   {
      ...
      if( (Object)outReal == (Object)inReal ) {
         throw new TaLibArgumentException("KURTOSIS openAndFill: " + RetCode.BadParam, RetCode.BadParam);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
