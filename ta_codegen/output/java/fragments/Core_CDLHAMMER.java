 ...
 */
                              ...
                              int outInteger[] )
   {
      ...
      int guardStart = clampedStart("CDLHAMMER", startIdx, cdlhammerLookback());
      ...
      RetCode retCode = cdlhammerImpl(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
   ...
   public static final class CdlhammerStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > MAX_INDEX )
            throw failure("CDLHAMMER advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
