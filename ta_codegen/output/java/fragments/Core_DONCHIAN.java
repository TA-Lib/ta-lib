...
/**** Streaming API *****/
   ...
   public static final class DonchianStream {
       ...
       * by one and nothing else moves — {@link #value(DonchianOut)} keeps answering the previous
       ...
       * {@link #value(DonchianOut)} still answers the previous value. Re-feed the bar when a
