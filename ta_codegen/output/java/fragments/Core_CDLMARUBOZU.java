 ...
 */
   ...
   RetCode CDLMARUBOZU_Body( int startIdx,
                             int endIdx,
                             double inOpen[],
                             double inHigh[],
                             double inLow[],
    ...
    * valid range shorter than {@link Core#CDLMARUBOZU_Lookback} is a <b>success
                                ...
                                int outInteger[] )
   {
      ...
      RetCode retCode = CDLMARUBOZU_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CDLMARUBOZU_Stream {
      ...
      /**
       * The range filled by {@link Core#CDLMARUBOZU_OpenAndFill}, or
    ...
    * {@link CDLMARUBOZU_Stream#fillRange()}.
    */
