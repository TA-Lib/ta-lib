 ...
 */
                         ...
                         double outReal[] )
   {
      ...
      int guardStart = clampedStart("CEIL", startIdx, ceilLookback());
      ...
      RetCode retCode = ceilImpl(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
...
/**** Streaming API *****/
   ...
   public static final class CeilStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("CEIL advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
      ...
      public double update( double inReal ) {
         if( this.outRangeBegIdx + this.outRangeCount > INDEX_MAX )
            throw failure("CEIL update", RetCode.OUT_OF_RANGE_END_INDEX);
         if( !Double.isFinite(inReal) )
            throw nonFiniteBar("CEIL update", "inReal");
      ...
      public double peek( double inReal ) {
         if( !Double.isFinite(inReal) )
            throw nonFiniteBar("CEIL peek", "inReal");
         CeilStream sp = this;
   ...
   CeilStream ceilOpenAndFillInternal( double inReal[], int startIdx, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("CEIL openAndFill", inReal.length, startIdx, ceilLookback());
      }
   ...
   CeilStream ceilOpenInternal( double inReal[], int startIdx )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("CEIL open", inReal.length, startIdx, ceilLookback());
      }
   ...
   public CeilStream ceilOpenAndFill( double inReal[], double outReal[] )
   {
      ...
      int guardOutLen = openFillCount("CEIL openAndFill", inReal.length, ceilLookback());
      requireLength("CEIL openAndFill", "outReal", outReal, guardOutLen);
      if( (Object)outReal == (Object)inReal ) {
         throw streamFailure("CEIL openAndFill", RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
