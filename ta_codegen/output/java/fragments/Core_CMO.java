...
/**** Streaming API *****/
   ...
   private RetCode cmoOpenImpl( CmoStream sp, double inReal[], int startIdx, int optInTimePeriod, MInteger outBegIdx, MInteger outNBElement, double outReal[], int outStride )
   {
      int outIdx = 0;
      int today = 0;
      int lookbackTotal = 0;
   ...
   CmoStream cmoOpenAndFillInternal( double inReal[], int startIdx, int optInTimePeriod, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      CmoStream sp = new CmoStream(this);
      RetCode retCode = cmoOpenImpl(sp, inReal, startIdx, optInTimePeriod, outBegIdx, outNBElement, outReal, 1);
   ...
   CmoStream cmoOpenInternal( double inReal[], int startIdx, int optInTimePeriod )
   {
      ...
      RetCode retCode = cmoOpenImpl(sp, inReal, startIdx, optInTimePeriod, outBegIdx, outNBElement, sink_outReal, 0);
      sp.outRangeBegIdx = outBegIdx.value;
      sp.outRangeCount = outNBElement.value;
      if( retCode == RetCode.Success ) {
         return sp;
   ...
   public CmoStream cmoOpenAndFill( double inReal[], int optInTimePeriod, double outReal[] )
   {
      ...
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      return cmoOpenAndFillInternal(inReal, 0, optInTimePeriod, outBegIdx, outNBElement, outReal);
   }
