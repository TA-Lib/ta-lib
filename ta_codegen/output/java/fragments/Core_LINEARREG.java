 ...
 */
                              ...
                              double outReal[] )
   {
      ...
      int guardStart = clampedStart("LINEARREG", startIdx, linearregLookback(optInTimePeriod));
      ...
      RetCode retCode = linearregImpl(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outReal);
