 ...
 */
   ...
   RetCode CDL2CROWS_Body( int startIdx,
                           int endIdx,
                           double inOpen[],
                           double inHigh[],
                           double inLow[],
                              ...
                              int outInteger[] )
   {
      ...
      RetCode retCode = CDL2CROWS_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CDL2CROWS_Stream {
      ...
      /**
       * The range filled by {@link Core#CDL2CROWS_OpenAndFill}, or
    ...
    * {@link CDL2CROWS_Stream#fillRange()}.
    */
