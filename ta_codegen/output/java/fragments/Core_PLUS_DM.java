...
/**** Streaming API *****/
   ...
   public static final class PlusDmStream {
      ...
      public double update( double inHigh, double inLow ) {
         ...
         if( !Double.isFinite(inHigh) || !Double.isFinite(inLow) )
            throw nonFiniteBar("PLUS_DM update", !Double.isFinite(inHigh) ? "inHigh" : "inLow");
      ...
      public double peek( double inHigh, double inLow ) {
         if( !Double.isFinite(inHigh) || !Double.isFinite(inLow) )
            throw nonFiniteBar("PLUS_DM peek", !Double.isFinite(inHigh) ? "inHigh" : "inLow");
   ...
   PlusDmStream plusDmOpenAndFillInternal( double inHigh[], double inLow[], int startIdx, int optInTimePeriod, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("PLUS_DM openAndFill", inHigh.length, startIdx, plusDmLookback(optInTimePeriod));
      }
   ...
   PlusDmStream plusDmOpenInternal( double inHigh[], double inLow[], int startIdx, int optInTimePeriod )
   {
      ...
      if( retCode == RetCode.INSUFFICIENT_HISTORY ) {
         throw insufficientHistory("PLUS_DM open", inHigh.length, startIdx, plusDmLookback(optInTimePeriod));
      }
   ...
   public PlusDmStream plusDmOpenAndFill( double inHigh[], double inLow[], int optInTimePeriod, double outReal[] )
   {
      ...
      if( (Object)outReal == (Object)inHigh || (Object)outReal == (Object)inLow ) {
         throw streamFailure("PLUS_DM openAndFill", RetCode.BAD_PARAM);
      }
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
