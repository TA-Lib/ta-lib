 ...
 */
                        ...
                        double outReal[] )
   {
      ...
      RetCode retCode = TSF_Body(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outReal);
...
/**** Streaming API *****/
   ...
   public static final class TSF_Stream {
      ...
      /**
       * The range filled by {@link Core#TSF_OpenAndFill}, or
