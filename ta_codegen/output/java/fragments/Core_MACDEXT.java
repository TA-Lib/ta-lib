 ...
 */
   ...
   RetCode MACDEXT_Body( int startIdx,
                         int endIdx,
                         double inReal[],
                         int optInFastPeriod,
                            ...
                            double outMACDHist[] )
   {
      ...
      RetCode retCode = MACDEXT_Body(startIdx, endIdx, inReal, optInFastPeriod, optInFastMAType, optInSlowPeriod, optInSlowMAType, optInSignalPeriod, optInSignalMAType, outBegIdx, outNBElement, outMACD, outMACDSignal, outMACDHist);
      if( retCode != RetCode.Success ) {
