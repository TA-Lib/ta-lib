 ...
 */
   ...
   RetCode CDL3LINESTRIKE_Body( int startIdx,
                                int endIdx,
                                double inOpen[],
                                double inHigh[],
                                double inLow[],
                                   ...
                                   int outInteger[] )
   {
      ...
      RetCode retCode = CDL3LINESTRIKE_Body(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
