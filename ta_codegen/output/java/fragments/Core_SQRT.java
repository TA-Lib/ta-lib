 ...
 */
                         ...
                         double outReal[] )
   {
      ...
      int guardStart = clampedStart("SQRT", startIdx, sqrtLookback());
      ...
      RetCode retCode = sqrtImpl(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
   ...
   public static final class SqrtStream {
      ...
      public void advance() {
         if( this.outRangeBegIdx + this.outRangeCount > MAX_INDEX )
            throw failure("SQRT advance", RetCode.OUT_OF_RANGE_END_INDEX);
         this.outRangeCount++;
      }
