...
/**** Streaming API *****/
    ...
    */
   public CdlEveningDojiStarStream cdlEveningDojiStarOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], double optInPenetration, MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlEveningDojiStarStream sp = new CdlEveningDojiStarStream(this);
