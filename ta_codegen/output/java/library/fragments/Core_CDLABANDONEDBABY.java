 ...
 */
   ...
   RetCode cdlAbandonedBabyUnguardedInternal( int startIdx,
                                              int endIdx,
                                              double inOpen[],
                                              double inHigh[],
                                              double inLow[],
    ...
    * into the first body. Bullish (bottom) or bearish (top) reversal signal.
    * Nonzero hit signals a reversal: +100 abandoned baby bottom (bullish), -100
    * abandoned baby top (bearish). — <b>unchecked</b> variant of
    * {@link Core#cdlAbandonedBaby}.
    ...
    */
   public OutRange cdlAbandonedBabyUnguarded( int startIdx,
                                              int endIdx,
                                              double inOpen[],
                                              double inHigh[],
                                              double inLow[],
                                              ...
                                              int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlAbandonedBabyUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, optInPenetration, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * A three-candle reversal pattern: a long body, then a gapped-away doji,
