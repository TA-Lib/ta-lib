 ...
 */
   ...
   RetCode rocR100UnguardedInternal( int startIdx,
                                     int endIdx,
                                     double inReal[],
                                     int optInTimePeriod,
                                     MInteger outBegIdx,
    ...
    * price optInTimePeriod bars ago. Momentum measure centered at 100 and
    * always positive. Above 100 = price rose vs n bars ago; below 100 = price
    * fell. — <b>unchecked</b> variant of {@link Core#rocR100}.
                                     ...
                                     double outReal[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      rocR100UnguardedInternal(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outReal);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Rate-of-change ratio scaled by 100: current price as a percentage of the
