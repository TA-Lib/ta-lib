 ...
 */
   ...
   RetCode cdlHangingManInternal( int startIdx,
                                  int endIdx,
                                  double inOpen[],
                                  double inHigh[],
                                  double inLow[],
   ...
   RetCode cdlHangingManUnguardedInternal( int startIdx,
                                           int endIdx,
                                           double inOpen[],
                                           double inHigh[],
                                           double inLow[],
                                  ...
                                  int outInteger[] )
   {
      ...
      RetCode retCode = cdlHangingManInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
    ...
    * upper shadow, sitting at or near the highs of the prior candle. Bearish
    * reversal signal. A hit is a bearish reversal signal (meaningful at the top
    * of an uptrend). — <b>unchecked</b> variant of {@link Core#cdlHangingMan}.
    ...
    */
   public OutRange cdlHangingManUnguarded( int startIdx,
                                           int endIdx,
                                           double inOpen[],
                                           double inHigh[],
                                           double inLow[],
                                           ...
                                           int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlHangingManUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Single candle with a small real body, a long lower shadow, and little/no
...
/**** Streaming API *****/
    ...
    * {@link CdlHangingManStream#fillRange()}.
    */
