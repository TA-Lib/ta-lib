 ...
 */
   ...
   RetCode cdlMarubozuInternal( int startIdx,
                                int endIdx,
                                double inOpen[],
                                double inHigh[],
                                double inLow[],
   ...
   RetCode cdlMarubozuUnguardedInternal( int startIdx,
                                         int endIdx,
                                         double inOpen[],
                                         double inHigh[],
                                         double inLow[],
                                ...
                                int outInteger[] )
   {
      ...
      RetCode retCode = cdlMarubozuInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CdlMarubozuStream {
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         core.cdlMarubozuStreamStep(this, inOpen, inHigh, inLow, inClose);
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         CdlMarubozuStream scratch = new CdlMarubozuStream(this);
         core.cdlMarubozuStreamStep(scratch, inOpen, inHigh, inLow, inClose);
   ...
   void cdlMarubozuStreamStep( CdlMarubozuStream sp, double inOpen, double inHigh, double inLow, double inClose )
   {
   ...
   private RetCode cdlMarubozuOpenBody( CdlMarubozuStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      double BodyLongPeriodTotal = 0;
      double ShadowVeryShortPeriodTotal = 0;
      int i = 0;
   ...
   private RetCode cdlMarubozuOpenAndFillBody( CdlMarubozuStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      double BodyLongPeriodTotal = 0;
      double ShadowVeryShortPeriodTotal = 0;
      int i = 0;
   ...
   CdlMarubozuStream cdlMarubozuOpenInternal( double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      ...
      RetCode retCode = cdlMarubozuOpenBody(sp, inOpen, inHigh, inLow, inClose, startIdx);
      if( retCode == RetCode.Success ) {
         return sp;
      }
    ...
    * {@link CdlMarubozuStream#fillRange()}.
    */
   public CdlMarubozuStream cdlMarubozuOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      RetCode retCode = cdlMarubozuOpenAndFillBody(sp, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
