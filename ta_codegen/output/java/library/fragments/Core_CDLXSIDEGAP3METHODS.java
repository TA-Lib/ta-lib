 ...
 */
   ...
   RetCode cdlXSideGap3MethodsInternal( int startIdx,
                                        int endIdx,
                                        double inOpen[],
                                        double inHigh[],
                                        double inLow[],
   ...
   RetCode cdlXSideGap3MethodsUnguardedInternal( int startIdx,
                                                 int endIdx,
                                                 double inOpen[],
                                                 double inHigh[],
                                                 double inLow[],
                                        ...
                                        int outInteger[] )
   {
      ...
      RetCode retCode = cdlXSideGap3MethodsInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
    ...
    * (downside) when they are black. A hit signals trend continuation: +100
    * bullish (uptrend resumes), -100 bearish (downtrend resumes). —
    * <b>unchecked</b> variant of {@link Core#cdlXSideGap3Methods}.
                                                 ...
                                                 int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlXSideGap3MethodsUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * A three-candle continuation pattern: two same-color candles separated by a
...
/**** Streaming API *****/
    ...
    * {@link CdlXSideGap3MethodsStream#fillRange()}.
    */
