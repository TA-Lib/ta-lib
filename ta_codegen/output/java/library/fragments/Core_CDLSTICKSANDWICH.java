 ...
 */
   ...
   RetCode cdlStickSandwichUnguardedInternal( int startIdx,
                                              int endIdx,
                                              double inOpen[],
                                              double inHigh[],
                                              double inLow[],
    ...
    * level as the 1st (the "bread"). A hit signals a bullish reversal (code
    * comment notes it is significant in a downtrend, which the function does
    * not verify). — <b>unchecked</b> variant of {@link Core#cdlStickSandwich}.
    ...
    */
   public OutRange cdlStickSandwichUnguarded( int startIdx,
                                              int endIdx,
                                              double inOpen[],
                                              double inHigh[],
                                              double inLow[],
                                              ...
                                              int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlStickSandwichUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * A three-candle bullish reversal pattern: two black candles (1st and 3rd)
