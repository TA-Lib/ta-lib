 ...
 */
   ...
   RetCode cdlLadderBottomUnguardedInternal( int startIdx,
                                             int endIdx,
                                             double inOpen[],
                                             double inHigh[],
                                             double inLow[],
    ...
    * white candle that opens above the prior open and closes above the prior
    * high. Signals a potential bottom reversal. A hit (+100) is a bullish
    * reversal signal, most meaningful after a downtrend. — <b>unchecked</b>
    * variant of {@link Core#cdlLadderBottom}.
    ...
    */
   public OutRange cdlLadderBottomUnguarded( int startIdx,
                                             int endIdx,
                                             double inOpen[],
                                             double inHigh[],
                                             double inLow[],
                                             ...
                                             int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlLadderBottomUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Five-candle bullish reversal pattern: three consecutively lower black
