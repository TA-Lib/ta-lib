 ...
 */
   ...
   RetCode cosInternal( int startIdx,
                        int endIdx,
                        double inReal[],
                        MInteger outBegIdx,
   ...
   RetCode cosUnguardedInternal( int startIdx,
                                 int endIdx,
                                 double inReal[],
                                 MInteger outBegIdx,
                                 MInteger outNBElement,
                        ...
                        double outReal[] )
   {
      ...
      RetCode retCode = cosInternal(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
   ...
   /**
    * Element-wise trigonometric cosine of the input series. Applies the C
    * library cos() to each sample. — <b>unchecked</b> variant of
    * {@link Core#cos}.
                                 ...
                                 double outReal[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cosUnguardedInternal(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Element-wise trigonometric cosine of the input series. Applies the C
