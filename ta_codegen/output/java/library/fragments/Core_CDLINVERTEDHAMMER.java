 ...
 */
   ...
   RetCode cdlInvertedHammerUnguardedInternal( int startIdx,
                                               int endIdx,
                                               double inOpen[],
                                               double inHigh[],
                                               double inLow[],
    ...
    * little-to-no lower shadow that gaps down from the prior candle. Bullish
    * reversal signal. A hit (+100) flags a potential bullish reversal. —
    * <b>unchecked</b> variant of {@link Core#cdlInvertedHammer}.
                                               ...
                                               int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlInvertedHammerUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Single-candle pattern: a small real body with a long upper shadow and
