...
/**** Streaming API *****/
    ...
    */
   public CdlHaramiStream cdlHaramiOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlHaramiStream sp = new CdlHaramiStream(this);
