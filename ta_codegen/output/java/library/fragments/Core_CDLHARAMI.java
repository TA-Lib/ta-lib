 ...
 */
   ...
   RetCode cdlHaramiInternal( int startIdx,
                              int endIdx,
                              double inOpen[],
                              double inHigh[],
                              double inLow[],
   ...
   RetCode cdlHaramiUnguardedInternal( int startIdx,
                                       int endIdx,
                                       double inOpen[],
                                       double inHigh[],
                                       double inLow[],
                              ...
                              int outInteger[] )
   {
      ...
      RetCode retCode = cdlHaramiInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
    ...
    * direction is the opposite of the first candle's color. A hit signals a
    * potential reversal opposite the 1st candle: positive (black 1st) is
    * bullish, negative (white 1st) is bearish. — <b>unchecked</b> variant of
    * {@link Core#cdlHarami}.
    ...
    */
   public OutRange cdlHaramiUnguarded( int startIdx,
                                       int endIdx,
                                       double inOpen[],
                                       double inHigh[],
                                       double inLow[],
                                       ...
                                       int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlHaramiUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Two-candle pattern: a long real body followed by a short real body
...
/**** Streaming API *****/
   ...
   public static final class CdlHaramiStream {
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         core.cdlHaramiStreamStep(this, inOpen, inHigh, inLow, inClose);
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         CdlHaramiStream scratch = new CdlHaramiStream(this);
         core.cdlHaramiStreamStep(scratch, inOpen, inHigh, inLow, inClose);
   ...
   void cdlHaramiStreamStep( CdlHaramiStream sp, double inOpen, double inHigh, double inLow, double inClose )
   {
   ...
   private RetCode cdlHaramiOpenBody( CdlHaramiStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      double BodyShortPeriodTotal = 0;
      double BodyLongPeriodTotal = 0;
      int i = 0;
   ...
   private RetCode cdlHaramiOpenAndFillBody( CdlHaramiStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      double BodyShortPeriodTotal = 0;
      double BodyLongPeriodTotal = 0;
      int i = 0;
   ...
   {
      CdlHaramiStream sp = new CdlHaramiStream(this);
      RetCode retCode = cdlHaramiOpenBody(sp, inOpen, inHigh, inLow, inClose, startIdx);
      if( retCode == RetCode.Success ) {
         return sp;
      }
    ...
    */
   public CdlHaramiStream cdlHaramiOpen( double inOpen[], double inHigh[], double inLow[], double inClose[] )
   {
      return cdlHaramiOpenInternal(inOpen, inHigh, inLow, inClose, 0);
   }
   /**
    ...
    * {@link CdlHaramiStream#fillRange()}.
    */
   public CdlHaramiStream cdlHaramiOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      CdlHaramiStream sp = new CdlHaramiStream(this);
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      RetCode retCode = cdlHaramiOpenAndFillBody(sp, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
