...
/**** Streaming API *****/
    ...
    */
   public CdlHammerStream cdlHammerOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlHammerStream sp = new CdlHammerStream(this);
