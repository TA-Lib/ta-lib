 ...
 */
   ...
   RetCode cdlInNeckUnguardedInternal( int startIdx,
                                       int endIdx,
                                       double inOpen[],
                                       double inHigh[],
                                       double inLow[],
    ...
    * prior body (near the prior close). It is a bearish continuation signal. A
    * hit signals bearish continuation (the down move is expected to resume). —
    * <b>unchecked</b> variant of {@link Core#cdlInNeck}.
    ...
    */
   public OutRange cdlInNeckUnguarded( int startIdx,
                                       int endIdx,
                                       double inOpen[],
                                       double inHigh[],
                                       double inLow[],
                                       ...
                                       int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlInNeckUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * A two-candle in-neck pattern: a long black candle followed by a white
