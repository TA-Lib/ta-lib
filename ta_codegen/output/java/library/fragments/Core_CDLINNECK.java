...
/**** Streaming API *****/
    ...
    */
   public CdlInNeckStream cdlInNeckOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlInNeckStream sp = new CdlInNeckStream(this);
