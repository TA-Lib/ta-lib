 ...
 */
   ...
   RetCode willRUnguardedInternal( int startIdx,
                                   int endIdx,
                                   double inHigh[],
                                   double inLow[],
                                   double inClose[],
    ...
    * 0]. Measures where the current close sits relative to the high-low range
    * of the last N bars. Near 0 = close at period high (overbought); near -100
    * = close at period low (oversold). — <b>unchecked</b> variant of
    * {@link Core#willR}.
    ...
    */
   public OutRange willRUnguarded( int startIdx,
                                   int endIdx,
                                   double inHigh[],
                                   double inLow[],
                                   double inClose[],
                                   ...
                                   double outReal[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      willRUnguardedInternal(startIdx, endIdx, inHigh, inLow, inClose, optInTimePeriod, outBegIdx, outNBElement, outReal);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Williams' %R momentum oscillator over a rolling period, bounded in [-100,
