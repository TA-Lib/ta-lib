 ...
 */
   ...
   RetCode cdlAdvanceBlockInternal( int startIdx,
                                    int endIdx,
                                    double inOpen[],
                                    double inHigh[],
                                    double inLow[],
   ...
   RetCode cdlAdvanceBlockUnguardedInternal( int startIdx,
                                             int endIdx,
                                             double inOpen[],
                                             double inHigh[],
                                             double inLow[],
                                    ...
                                    int outInteger[] )
   {
      ...
      RetCode retCode = cdlAdvanceBlockInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
    ...
    * advance is being blocked. A hit (-100) is bearish: the advance is
    * stalling/blocked; meaningful mainly within an existing uptrend. —
    * <b>unchecked</b> variant of {@link Core#cdlAdvanceBlock}.
                                             ...
                                             int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlAdvanceBlockUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Three-candle bearish reversal pattern: three white candles with
...
/**** Streaming API *****/
    ...
    * {@link CdlAdvanceBlockStream#fillRange()}.
    */
