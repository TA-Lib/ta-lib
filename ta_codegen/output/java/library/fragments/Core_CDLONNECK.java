 ...
 */
   ...
   RetCode cdlOnNeckInternal( int startIdx,
                              int endIdx,
                              double inOpen[],
                              double inHigh[],
                              double inLow[],
   ...
   RetCode cdlOnNeckUnguardedInternal( int startIdx,
                                       int endIdx,
                                       double inOpen[],
                                       double inHigh[],
                                       double inLow[],
                              ...
                              int outInteger[] )
   {
      ...
      RetCode retCode = cdlOnNeckInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
...
/**** Streaming API *****/
   ...
   public static final class CdlOnNeckStream {
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         core.cdlOnNeckStreamStep(this, inOpen, inHigh, inLow, inClose);
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         CdlOnNeckStream scratch = new CdlOnNeckStream(this);
         core.cdlOnNeckStreamStep(scratch, inOpen, inHigh, inLow, inClose);
   ...
   void cdlOnNeckStreamStep( CdlOnNeckStream sp, double inOpen, double inHigh, double inLow, double inClose )
   {
   ...
   private RetCode cdlOnNeckOpenBody( CdlOnNeckStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      double EqualPeriodTotal = 0;
      double BodyLongPeriodTotal = 0;
      int i = 0;
   ...
   private RetCode cdlOnNeckOpenAndFillBody( CdlOnNeckStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      double EqualPeriodTotal = 0;
      double BodyLongPeriodTotal = 0;
      int i = 0;
   ...
   CdlOnNeckStream cdlOnNeckOpenInternal( double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      ...
      RetCode retCode = cdlOnNeckOpenBody(sp, inOpen, inHigh, inLow, inClose, startIdx);
      if( retCode == RetCode.Success ) {
         return sp;
      }
    ...
    * {@link CdlOnNeckStream#fillRange()}.
    */
   public CdlOnNeckStream cdlOnNeckOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      RetCode retCode = cdlOnNeckOpenAndFillBody(sp, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
