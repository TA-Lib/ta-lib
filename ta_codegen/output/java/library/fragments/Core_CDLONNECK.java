...
/**** Streaming API *****/
    ...
    */
   public CdlOnNeckStream cdlOnNeckOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlOnNeckStream sp = new CdlOnNeckStream(this);
