...
/**** Streaming API *****/
    ...
    */
   public CdlShortLineStream cdlShortLineOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlShortLineStream sp = new CdlShortLineStream(this);
