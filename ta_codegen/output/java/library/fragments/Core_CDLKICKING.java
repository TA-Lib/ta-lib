 ...
 */
   ...
   RetCode cdlKickingInternal( int startIdx,
                               int endIdx,
                               double inOpen[],
                               double inHigh[],
                               double inLow[],
   ...
   RetCode cdlKickingUnguardedInternal( int startIdx,
                                        int endIdx,
                                        double inOpen[],
                                        double inHigh[],
                                        double inLow[],
                               ...
                               int outInteger[] )
   {
      ...
      RetCode retCode = cdlKickingInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
    ...
    * is set by the second candle's color. Hit signals a reversal in the
    * direction of the second candle: +100 bullish, -100 bearish. —
    * <b>unchecked</b> variant of {@link Core#cdlKicking}.
    ...
    */
   public OutRange cdlKickingUnguarded( int startIdx,
                                        int endIdx,
                                        double inOpen[],
                                        double inHigh[],
                                        double inLow[],
                                        ...
                                        int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlKickingUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Two-candle pattern of two opposite-color marubozu (long bodies with very
...
/**** Streaming API *****/
   ...
   public static final class CdlKickingStream {
      ...
      public int update( double inOpen, double inHigh, double inLow, double inClose ) {
         core.cdlKickingStreamStep(this, inOpen, inHigh, inLow, inClose);
      ...
      public int peek( double inOpen, double inHigh, double inLow, double inClose ) {
         CdlKickingStream scratch = new CdlKickingStream(this);
         core.cdlKickingStreamStep(scratch, inOpen, inHigh, inLow, inClose);
   ...
   void cdlKickingStreamStep( CdlKickingStream sp, double inOpen, double inHigh, double inLow, double inClose )
   {
   ...
   private RetCode cdlKickingOpenBody( CdlKickingStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      double[] ShadowVeryShortPeriodTotal = new double[2];
      double[] BodyLongPeriodTotal = new double[2];
      int i = 0;
   ...
   private RetCode cdlKickingOpenAndFillBody( CdlKickingStream sp, double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      double[] ShadowVeryShortPeriodTotal = new double[2];
      double[] BodyLongPeriodTotal = new double[2];
      int i = 0;
   ...
   CdlKickingStream cdlKickingOpenInternal( double inOpen[], double inHigh[], double inLow[], double inClose[], int startIdx )
   {
      ...
      RetCode retCode = cdlKickingOpenBody(sp, inOpen, inHigh, inLow, inClose, startIdx);
      if( retCode == RetCode.Success ) {
         return sp;
      }
    ...
    * {@link CdlKickingStream#fillRange()}.
    */
   public CdlKickingStream cdlKickingOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], int outInteger[] )
   {
      ...
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      RetCode retCode = cdlKickingOpenAndFillBody(sp, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
