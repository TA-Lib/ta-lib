...
/**** Streaming API *****/
    ...
    */
   public CdlTakuriStream cdlTakuriOpenAndFill( double inOpen[], double inHigh[], double inLow[], double inClose[], MInteger outBegIdx, MInteger outNBElement, int outInteger[] )
   {
      CdlTakuriStream sp = new CdlTakuriStream(this);
