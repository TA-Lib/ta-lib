 ...
 */
   ...
   RetCode cdlThrustingUnguardedInternal( int startIdx,
                                          int endIdx,
                                          double inOpen[],
                                          double inHigh[],
                                          double inLow[],
    ...
    * its midpoint. It is a bearish continuation signal. A hit is bearish: the
    * failed white push back into the black body signals continuation of the
    * down move. — <b>unchecked</b> variant of {@link Core#cdlThrusting}.
                                          ...
                                          int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlThrustingUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * A two-candle pattern: a long black candle followed by a white candle that
