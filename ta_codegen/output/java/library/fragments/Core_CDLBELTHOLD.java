 ...
 */
   ...
   RetCode cdlBeltHoldUnguardedInternal( int startIdx,
                                         int endIdx,
                                         double inOpen[],
                                         double inHigh[],
                                         double inLow[],
    ...
    * short upper shadow. A white hit is bullish (opens at the low, closes
    * strong); a black hit is bearish (opens at the high, closes weak). —
    * <b>unchecked</b> variant of {@link Core#cdlBeltHold}.
    ...
    */
   public OutRange cdlBeltHoldUnguarded( int startIdx,
                                         int endIdx,
                                         double inOpen[],
                                         double inHigh[],
                                         double inLow[],
                                         ...
                                         int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlBeltHoldUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Single-candle pattern with a long real body that opens at (or near) its
