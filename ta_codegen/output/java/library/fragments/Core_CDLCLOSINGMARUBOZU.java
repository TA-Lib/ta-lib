 ...
 */
   ...
   RetCode cdlClosingMarubozuUnguardedInternal( int startIdx,
                                                int endIdx,
                                                double inOpen[],
                                                double inHigh[],
                                                double inLow[],
    ...
    * strong bar that emits +100 for a white body and -100 for a black body.
    * White (+100) is bullish, black (-100) is bearish; a strong directional
    * bar, not a defined reversal/continuation signal. — <b>unchecked</b>
    * variant of {@link Core#cdlClosingMarubozu}.
    ...
    */
   public OutRange cdlClosingMarubozuUnguarded( int startIdx,
                                                int endIdx,
                                                double inOpen[],
                                                double inHigh[],
                                                double inLow[],
                                                ...
                                                int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlClosingMarubozuUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Single-candle pattern: a long real body whose closing end has no or very
