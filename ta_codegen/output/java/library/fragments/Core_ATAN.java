 ...
 */
   ...
   RetCode atanUnguardedInternal( int startIdx,
                                  int endIdx,
                                  double inReal[],
                                  MInteger outBegIdx,
                                  MInteger outNBElement,
   ...
   /**
    * Vector trigonometric arc tangent: applies atan element-wise to each input.
    * Pure math transform with no lookback. — <b>unchecked</b> variant of
    * {@link Core#atan}.
    ...
    */
   public OutRange atanUnguarded( int startIdx,
                                  int endIdx,
                                  double inReal[],
                                  double outReal[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      atanUnguardedInternal(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Vector trigonometric arc tangent: applies atan element-wise to each input.
