...
/**** Streaming API *****/
    ...
    */
   public PpoStream ppoOpenAndFill( double inReal[], int optInFastPeriod, int optInSlowPeriod, MAType optInMAType, MInteger outBegIdx, MInteger outNBElement, double outReal[] )
   {
      PpoStream sp = new PpoStream(this);
