 ...
 */
   ...
   RetCode minUnguardedInternal( int startIdx,
                                 int endIdx,
                                 double inReal[],
                                 int optInTimePeriod,
                                 MInteger outBegIdx,
   ...
   /**
    * Rolling minimum: the lowest input value over the trailing period. —
    * <b>unchecked</b> variant of {@link Core#min}.
    ...
    */
   public OutRange minUnguarded( int startIdx,
                                 int endIdx,
                                 double inReal[],
                                 int optInTimePeriod,
                                 double outReal[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      minUnguardedInternal(startIdx, endIdx, inReal, optInTimePeriod, outBegIdx, outNBElement, outReal);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Rolling minimum: the lowest input value over the trailing period.
