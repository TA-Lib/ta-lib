 ...
 */
   ...
   RetCode cdlEveningStarUnguardedInternal( int startIdx,
                                            int endIdx,
                                            double inOpen[],
                                            double inHigh[],
                                            double inLow[],
    ...
    * short-bodied star gapping up, then a black candle closing well down into
    * the first candle's body. A hit signals a bearish reversal (most
    * significant in an uptrend). — <b>unchecked</b> variant of
    * {@link Core#cdlEveningStar}.
    ...
    */
   public OutRange cdlEveningStarUnguarded( int startIdx,
                                            int endIdx,
                                            double inOpen[],
                                            double inHigh[],
                                            double inLow[],
                                            ...
                                            int outInteger[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      cdlEveningStarUnguardedInternal(startIdx, endIdx, inOpen, inHigh, inLow, inClose, optInPenetration, outBegIdx, outNBElement, outInteger);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * A three-candle bearish reversal pattern: a long white candle, a
