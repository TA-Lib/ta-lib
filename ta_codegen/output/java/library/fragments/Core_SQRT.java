 ...
 */
   ...
   RetCode sqrtUnguardedInternal( int startIdx,
                                  int endIdx,
                                  double inReal[],
                                  MInteger outBegIdx,
                                  MInteger outNBElement,
   ...
   /**
    * Vector square root: applies the square-root function element-wise to each
    * input value. — <b>unchecked</b> variant of {@link Core#sqrt}.
    ...
    */
   public OutRange sqrtUnguarded( int startIdx,
                                  int endIdx,
                                  double inReal[],
                                  double outReal[] )
   {
      MInteger outBegIdx = new MInteger();
      MInteger outNBElement = new MInteger();
      sqrtUnguardedInternal(startIdx, endIdx, inReal, outBegIdx, outNBElement, outReal);
      return new OutRange(outBegIdx.value, outNBElement.value);
   }
   /**
    * Vector square root: applies the square-root function element-wise to each
