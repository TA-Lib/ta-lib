...
//! unknown sections are ignored, missing optional sections yield empty fields.
//!
//! `## Formula` is not parsed: it renders on the ta-lib.org page only, from the
//! raw markdown, and the API doc targets link out to it instead.
