...
pub fn generate_c_server(funcs: &[FuncDef], enums: &HashMap<String, EnumDef>) -> String {
    ...
    s.push_str(&generate_c_ridealong(funcs));
...
fn generate_c_ridealong(funcs: &[FuncDef]) -> String {
    let (n_out_real, n_out_int) = crate::backends::common::max_output_arity(funcs);
    let mut s = String::new();
    s.push_str("#ifndef TA_REF_SERVE\n");
...
"#);
    ...
    s.push_str(&generate_java_ridealong(funcs));
...
pub fn generate_csharp_server(funcs: &[FuncDef], enums: &HashMap<String, EnumDef>) -> String {
    ...
    s.push_str(&generate_csharp_ridealong(funcs));
...
pub fn generate_rust_server(funcs: &[FuncDef], enums: &HashMap<String, EnumDef>) -> String {
    ...
    s.push_str(&generate_rust_ridealong(funcs));
...
fn generate_rust_ridealong(funcs: &[FuncDef]) -> String {
    let mut s = String::new();
...
fn generate_java_ridealong(funcs: &[FuncDef]) -> String {
    let mut s = String::new();
...
fn generate_csharp_ridealong(funcs: &[FuncDef]) -> String {
    let mut s = String::new();
