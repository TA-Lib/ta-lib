...
//! `docs/studies/fma-readiness-audit.md`): each function faithfully implements
//! its algorithm within a documented ~1e-9 relative tolerance, not bit-for-bit.
...
/// detector going dark. `enums_suite::rust_fma_dispatch_fires_for_exactly_the_fusing_functions`
...
pub const FUSING_INVENTORY: &[&str] = &[
    ...
    "fosc", "ht_dcperiod", "ht_dcphase", "ht_phasor", "ht_sine",
    "ht_trendline", "ht_trendmode", "kama", "linearreg", "macd", "macdfix",
    "mama", "natr", "rma", "sar", "sarext", "smi", "supertrend", "t3", "tema",
    "trix", "tsf", "wclprice", "zlema",
];
