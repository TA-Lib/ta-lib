...
typedef enum
{
  ...
  TA_YAHOO_ADDDATASOURCE_USA_FAILED     = 322,
  TA_YAHOO_HISTORYALLOC_1_FAILED        = 323,
  TA_YAHOO_HISTORYALLOC_2_FAILED        = 324,
  TA_YAHOO_HISTORYALLOC_3_FAILED        = 325,
  TA_YAHOO_HISTORYFREE_FAILED           = 326,
  TA_YAHOO_VALUE_1_FAILED               = 327,
  TA_YAHOO_VALUE_2_FAILED               = 328,
  TA_YAHOO_VALUE_3_FAILED               = 329,
  TA_YAHOO_FIELD_MISSING_1              = 330,
  TA_YAHOO_FIELD_MISSING_2              = 331,
  TA_YAHOO_FIELD_MISSING_3              = 332,
  TA_YAHOO_CRS_HISTORYALLOC_FAILED      = 333,
  TA_YAHOO_CRS_NBBARSBAD                = 334,
  TA_YAHOO_CRS_PRICEBARBAD              = 335,
  TA_YAHOO_ADDDATASOURCE_CAN_FAILED     = 336,
