...
| L2 | …and the signal is returned **exactly when** the batch tier would reject the same parameters under B4, or the streaming opener (`Open`/`OpenAndFill`) would reject them under S5 | the lookback rejection signal | ✅ | ✅ | ✅ | ✅ |
