                          ...
                          TA_ParamHolderPriv  out[] )
{
   return TA_STOCHF( libHandle,
               ...
               optIn[1].p.optIn.data.optInInteger, /* optInFastD_Period_1 */
               optIn[2].p.optIn.data.optInInteger, /* optInFastD_MAType_2 */
               outBegIdx, 
               outNbElement, 
               out[0].p.out.data.outReal, /*  outFastK_0 */
               out[1].p.out.data.outReal /*  outFastD_1 */ );
}
