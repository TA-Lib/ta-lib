...
typedef enum
{
  ...
  /* Error code realted to test_candlestick */
  TA_TSTCDL_GETFUNCHANDLE_FAIL,
  TA_TSTCDL_PARAMHOLDERALLOC_FAIL,
  TA_TSTCDL_NBINPUT_WRONG,
  TA_TSTCDL_INPUT_TYPE_WRONG,
  TA_TSTCDL_INPUT_FLAG_WRONG,
  TA_TSTCDL_NBOUTPUT_WRONG,
  TA_TSTCDL_OUTPUT_TYPE_WRONG,
  TA_TSTCDL_CALLFUNC_FAIL,
  TA_TSTCDL_GETLOOKBACK_FAIL,
  TA_TSTCDL_PARAMHOLDERFREE_FAIL,
