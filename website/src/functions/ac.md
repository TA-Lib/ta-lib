...
| --- | --- | --- | --- | --- |
| `optInFastPeriod` | integer | 5 | 2–100000 | Number of bars in the short moving average of the median price. Default 5, the value Williams uses and every surveyed package ships. |
| `optInSlowPeriod` | integer | 34 | 2–100000 | Number of bars in the long moving average of the median price. Default 34, likewise universal. |
| `optInSignalPeriod` | integer | 5 | 2–100000 | Number of bars in the moving average taken over the oscillator. Default 5. MetaTrader, Quantower and cTrader hardcode all three; trading-signals exposes all three with these same values. |
