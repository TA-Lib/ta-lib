...
description: "Vertical Horizontal Filter: Adam White's trend-versus-range filter, the net directional travel of a window divided by the total distance actually…"
---
